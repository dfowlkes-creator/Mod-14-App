...
public class RestaurantApiController {
     ...
     * @return ResponseEntity with the created restaurant's data, or a
    ...
    public ResponseEntity<Object> updateRestaurant(@PathVariable("id") int id,
        ...
        Optional<ApiCreateRestaurantDto> updatedRestaurant = restaurantService.updateRestaurant(id,
     ...
     * @return ResponseEntity with HTTP 200 OK if the restaurant is found, HTTP 404
     *         Not Found otherwise.
     *
    ...
    public ResponseEntity<Object> getRestaurantById(@PathVariable int id) {
        ...
        if (!restaurantWithRatingOptional.isPresent())
            throw new ResourceNotFoundException(String.format("Restaurant not found", id));
     ...
     * 
     * @see RestaurantService#findRestaurantsByRatingAndPriceRange(Integer, Integer)
