...
// @MockBean
// private com.rocketFoodDelivery.rocketFood.service.ProductService
// productService;
...
// order.setRestaurant_address("38118 Fredericka Island, North Trevamouth,
// 54474");
...
// .andExpect(MockMvcResultMatchers.jsonPath("$[0].customer_name").value("Kum
// Schmitt"))
// .andExpect(MockMvcResultMatchers.jsonPath("$[0].customer_address").value("764
// Daugherty Center, Yajairaton, 59313-9193"))
// .andExpect(MockMvcResultMatchers.jsonPath("$[0].restaurant_id").value(7))
// .andExpect(MockMvcResultMatchers.jsonPath("$[0].restaurant_name").value("Robel,
// Crona and Waters"))
// .andExpect(MockMvcResultMatchers.jsonPath("$[0].restaurant_address").value("38118
// Fredericka Island, North Trevamouth, 54474"))
...
// .andExpect(MockMvcResultMatchers.jsonPath("$[0].products[0].product_name").value("Chicken
// Fajitas"))
...
// .andExpect(MockMvcResultMatchers.jsonPath("$.error").value("Invalid user
// type"));
// }
...
// .andExpect(MockMvcResultMatchers.jsonPath("$.error").value("Both 'user type'
// and 'id' parameters are required"));
// }
...
// .andExpect(MockMvcResultMatchers.status().isCreated()) // Check for 201
// Created status
// .andExpect(MockMvcResultMatchers.jsonPath("$.id").value(70))
// .andExpect(MockMvcResultMatchers.jsonPath("$.customer_id").value(1))
// .andExpect(MockMvcResultMatchers.jsonPath("$.customer_name").value("Melisa
// Collier"))
// .andExpect(MockMvcResultMatchers.jsonPath("$.restaurant_id").value(1))
// .andExpect(MockMvcResultMatchers.jsonPath("$.restaurant_name").value("Updated
// Name"))
...
// .andExpect(MockMvcResultMatchers.status().isBadRequest()) // Verify status is
// 400
// .andExpect(MockMvcResultMatchers.jsonPath("$.error").value("Restaurant ID,
// customer ID, and products are required"));
// }
...
// .contentType(MediaType.APPLICATION_JSON)
// .content(asJsonString(orderDTO)))
// .andExpect(MockMvcResultMatchers.status().isUnprocessableEntity()) // Verify
// status is 422
// .andExpect(MockMvcResultMatchers.jsonPath("$.error").value("Invalid
// restaurant or customer ID"));
// }
...
// .andExpect(MockMvcResultMatchers.status().isUnprocessableEntity()) // Verify
// status is 422
// .andExpect(MockMvcResultMatchers.jsonPath("$.error").value("Invalid product
// ID"));
// }
