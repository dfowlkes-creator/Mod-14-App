    ...
    public ResponseEntity<Object> createOrder(@RequestBody ApiOrderDTO apiOrderDTO) {
        try {
            ...
            if (apiOrderDTO.getCustomer_id() == 0 ||
                ...
                return new ResponseEntity<>(Map.of("error", "Restaurant ID, customer ID, and products are required"),
            ...
            try {
                ...
                if (e.getMessage().contains("Customer not found") || e.getMessage().contains("Restaurant not found")) {
                    return new ResponseEntity<>(Map.of("error", "Invalid restaurant or customer ID"),
                    ...
                    return new ResponseEntity<>(Map.of("error", "An unexpected error occurred"),
            ...
            return new ResponseEntity<>(Map.of("error", "An error occurred while processing your request"),
                    HttpStatus.BAD_REQUEST);
        }
    }
